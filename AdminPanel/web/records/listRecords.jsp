...
<table class="tableRecords" c>
    ...
    <logic:iterate id="user" name="Records" property="users">
        <tr>
            <td class="delete" onclick="getDrivers('${pageContext.request.contextPath}/protected/delete.do?id=<bean:write name="user" property="id" format=""/>&table=route', 'post', 'data')"><img src="${pageContext.request.contextPath}/images/delete.jpg"></td>
